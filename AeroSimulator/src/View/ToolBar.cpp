...
ToolBar::ToolBar(QToolBar *parent)
    : QToolBar(parent)
{
    openAction = new QAction(QIcon("Assets/Pulsanti/Apri.svg"), tr("Apri"), this);
    saveAction = new QAction(QIcon("Assets/Pulsanti/Salva.svg"), tr("Salva"), this);
    saveAsAction = new QAction(QIcon("Assets/Pulsanti/Salva_con_nome.svg"), tr("Salva con nome"), this);
...
void ToolBar::openJsonFile(Sensor::Repository::JsonRepository*& repository)
{
...
void ToolBar::saveJsonFile(const std::vector<Sensor::AbstractSensor*>& sensors, Sensor::Repository::JsonRepository*& repository)
{
    if (repository == nullptr) {
...
void ToolBar::saveJsonFileAs(const std::vector<Sensor::AbstractSensor*>& sensors, Sensor::Repository::JsonRepository*& repository)
{
    QString defaultFolder = "JsonDocuments";
    QFileDialog dialog(this);
    dialog.setDirectory(defaultFolder);
